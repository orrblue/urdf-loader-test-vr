...
export class Data {
  ...
  SESSION_ID = id();
  SCRIPT_PATH =
    "https://script.google.com/macros/s/AKfycbzwApGpPCnrxRGrndclYFbO4szYDzn0llJamw8DqAUKVwEUeLGRBy-OMIoPm7EUapBO/exec";
  ...
  async initSession() {
    const ip = await fetch("https://api.ipify.org").then((response) => {
