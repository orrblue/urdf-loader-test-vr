...
use crate::groove::env_collision::{RelaxedIKEnvCollision};
...
impl RelaxedIKVars {
    pub fn new( config: VarsConstructorData, 
                nn_config: CollisionNNConstructorData, 
                env_config: EnvCollisionFileParserConstructorData) -> Self {
